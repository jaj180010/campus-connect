...
export default function EventCard({ title, imageSource, time, date, description, location, onPress, navigation }) {
  ...
  return (
    <TouchableOpacity onPress={onPress} style={eventCardStyles.container}>
